...
export default function IndexRoute() {
    ...
    return (
        <html.div style={styles.container}>
            ...
            <html.p>This is a paragraph. We can use all the nice DOM elements, including semantic elements which are native to web.</html.p>
            <html.section style={styles.section}>
                <html.h2>Links and buttons</html.h2>
                <html.a href="https://google.com">Link (href does not work on mobile) Go to google</html.a>
                <html.br/>
                <html.button style={[styles.button, {padding: tokens.spacingSmall}]} onClick={() => printPlatform()}>Button</html.button>
                <html.br/>
                <html.p>Link below uses navigation from expo-router</html.p>
                <html.a style={styles.link} onClick={() => router.navigate('/landing')}>Go to landing page</html.a>
            </html.section>
            <html.section style={styles.section}>
